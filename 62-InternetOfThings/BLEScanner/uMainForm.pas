...
begin
  ...
  begin
    ...
    DiscoveredDeviceName := (DiscoveredDeviceIndex + 1).ToString + ' - ' +
      DiscoveredDeviceName + ' - ' + DiscoveredDevice.Identifier;
...
begin
  ...
  begin
    ...
    begin
      ...
      ListBox2.Items.Add((ServiceIndex + 1).ToString + ' - ' + Service.UUIDName
      ...
      begin
        ...
        ListBox2.Items.Add('    - ' + Characteristic.UUIDName + ' - ' +
...
begin
  ...
  TThread.CreateAnonymousThread(
    procedure
    begin
      if not BluetoothLE1.DiscoveredDevices[ListBox1.ItemIndex].DiscoverServices
      then
...
procedure TForm6.RequestPermissionsResult(Sender: TObject;
const APermissions: TArray<string>;
const AGrantResults: TArray<TPermissionStatus>);
begin
